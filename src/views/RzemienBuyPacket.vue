    ...
    <div class="buy-ticket-wrapper">
        ...
        <form>
            ...
            <div class="input-wrapper textarea-wrapper">
                <label for="message">Wiadomość/Dane do faktury (opcjonalnie):</label>
                <textarea name="message" id="message" cols="30" rows="10" placeholder="Wiadomość" v-model="message"></textarea>
    ...
    setup() {
        ...
        const validateMessage = () => {
            if (message.value.trim().length > 1000) {
                messageMessage.value = 'Wiadomość nie może być dłuższa niż 1000 znaków';
                return false;
            }
